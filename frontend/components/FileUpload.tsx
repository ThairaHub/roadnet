...
export default function FileUpload({
  ...
  const handleFileSelect = async (selectedFile: File | null) => {
    ...
    const result = await geoJsonApi.upload_update(endpoint, endpoint_method, selectedFile)
  ...
  return (
    <div className="flex items-center justify-center h-full">
      ...
      >
        <Card className="w-full max-w-md mx-auto overflow-hidden min-h-[550px] flex flex-col bg-white dark:bg-zinc-900 border-zinc-200/50 dark:border-zinc-800/50 shadow-lg shadow-zinc-200/50 dark:shadow-zinc-900/50">
                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        type="button"
                        className="px-4 py-2 text-sm font-medium text-red-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300 border border-red-200 hover:border-red-300 dark:border-green-800 dark:hover:border-green-700 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-zinc-900"
